...
M.qtype_easyocd = {
    showmyresponse: function(Y, moodle_version, slot) {
        ...
        refreshBut.on("click", function() {
            var newxmlStr = document.getElementById('my_answer' +
                slot).value;
            MarvinJSUtil.getEditor("#EASYOCD" + slot).then(
    ...
    insert_easyocd_applet: function(Y, toreplaceid, appletid, name,
...
M.qtype_easyocd.init_getanswerstring = function(Y, moodle_version) {
...
M.qtype_easyocd.init_viewanswerstring = function(Y, moodle_version) {
    var handleSuccess = function(o) {};
    var handleFailure = function(o) {
        /*failure handler code*/
    };
        ...
        node.on("click", function() {
            ...
            MarvinJSUtil.getEditor("#MSketch").then(
                function(sketcherInstance) {
                   ...
                   Y.one('#answernumber').set('innerHTML', M.util.get_string('viewing_answer', 'qtype_easyocd')+' ' + answernumber);
