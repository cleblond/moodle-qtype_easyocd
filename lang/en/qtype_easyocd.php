...
/**
 * Strings for component 'qtype_easyocd', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    qtype
 * @subpackage easyocd
...
$string['pluginname'] = 'Chemistry - Name to Structure or Reaction (ChemDoodle)';
...
$string['easyocd_options'] = 'Path to ChemDoodle installation';
$string['easyocdobabel_options'] = 'Path to OpenBabel installation';
$string['pluginname_link'] = 'question/type/easyocd';
...
$string['configeasyocdoptions'] = 'The path of your MarvinJS installation relative to your web root.  (e.g. If your moodle is installed at /var/www/moodle and you install your MarvinJS at /var/www/marvinjs then you should use the default /marvinjs)';

$string['configeasyocdobabeloptions'] = 'The path to your openbabel (obabel) executable.';
...
$string['easyocdeditor'] = 'ChemDoodle Editor';
