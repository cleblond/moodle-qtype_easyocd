...
/**
 * easyocd Molecular Editor question definition class.
 *
 * @package    qtype
 * @subpackage easyocd
...
global $PAGE;
$PAGE->requires->strings_for_js(array('viewing_answer1', 'viewing_answer'), 'qtype_easyocd');

class qtype_easyocd_question extends qtype_shortanswer_question {
